...
#
# Generated by Vivado on Sun Aug 19 08:18:01 GMT 2018
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/feilong/Storages/fpga/25_3_uart_ddr/CH01_DDR3_READ_WRITE/mig_7series_0_ex.cache/compile_simlib/modelsim"
  fi
