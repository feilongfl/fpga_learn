...
#
# Generated by export_simulation on Tue Aug 14 15:25:42 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './mig_7series_2.sh' script.

./mig_7series_2.sh -reset_run
...
./mig_7series_2.sh -noclean_files

For more information on the script, please type './mig_7series_2.sh -help'.
