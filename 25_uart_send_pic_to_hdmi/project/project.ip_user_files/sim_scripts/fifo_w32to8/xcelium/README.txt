...
#
# Generated by export_simulation on Mon Aug 13 16:47:28 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './fifo_w32to8.sh' script.

./fifo_w32to8.sh -reset_run
...
./fifo_w32to8.sh -noclean_files

For more information on the script, please type './fifo_w32to8.sh -help'.
