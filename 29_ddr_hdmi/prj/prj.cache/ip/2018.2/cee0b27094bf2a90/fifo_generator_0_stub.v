...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wr_clk, wr_rst, rd_clk, rd_rst, din, wr_en, rd_en, 
  dout, full, almost_full, empty)
/* synthesis syn_black_box black_box_pad_pin="wr_clk,wr_rst,rd_clk,rd_rst,din[255:0],wr_en,rd_en,dout[31:0],full,almost_full,empty" */;
  input wr_clk;
  input wr_rst;
  input rd_clk;
  input rd_rst;
