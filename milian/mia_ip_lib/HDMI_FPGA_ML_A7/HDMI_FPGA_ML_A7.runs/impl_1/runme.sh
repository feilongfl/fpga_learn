...
HD_PWD='F:/A7_HDMI/HDMI_FPGA_ML_A7/HDMI_FPGA_ML_A7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_FPGA_ML_A7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_FPGA_ML_A7.tcl -notrace
